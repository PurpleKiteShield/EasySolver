...
using EasySolver.Data;
using EasySolver.Helpers;
using EasySolver.Localization;
using EasySolver.UI.SearchableConfigs;
using EasySolver.UI.SearchableSettings;
...
public partial class RotationConfigWindow : Window
{
    ...
    private const int FRAME_COUNT = 144;
    ...
    {
        var url = $"EasySolver.Logos.{name}.png";
    ...
    private static void DrawAboutLinks()
    {
        ...
        if (IconSet.GetTexture("https://GitHub-readme-stats.vercel.app/api/pin/?username=UnstableFlipPhone&repo=EasySolver&theme=dark", out var icon) && ImGuiHelper.TextureButton(icon, width, width))
        {
