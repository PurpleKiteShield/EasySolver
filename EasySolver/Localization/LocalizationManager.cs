...
namespace EasySolver.Localization;
...
internal class LocalizationManager : IDisposable
{
    ...
    private async void SetLanguage(string lang)
    {
        ...
        else
        {
            try
            {
                var url = $"https://raw.githubusercontent.com/{Service.USERNAME}/{Service.REPO}/main/EasySolver/Localization/{lang}.json";
    ...
    {
        var directory = @"E:\OneDrive - stu.zafu.edu.cn\PartTime\FFXIV\EasySolver\EasySolver\Localization";
